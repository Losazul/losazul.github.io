...
description: "Los monitores con mejor relación calidad-precio. Encuentra tu equipo gaming definitivo."
comments: false
---
...
<article class="hentry">
  <header>
    ...
    <div class="entry-meta">
      <span class="entry-date date published updated">Publicado el <time datetime="{{ post.date | date_to_xmlschema }}"><a href="{{ site.url }}{{ post.url }}">{% include date_es.html date=post.date %}</a></time></span><span class="author vcard"><span class="fn"><a href="{{ site.url }}/about/" title="About {{ site.owner.name }}"></a></span></span>
  ...
  <div class="entry-content">
      ...
      {% if post.content contains "<!-- more -->" %}
          ...
          <br>
          <div align="center">
              <div markdown="0"><a href="{{ site.url }}{{ post.url }}" class="btn btn-info">Leer más ...</a></div></div>
      {% endif %}
<br>
<div class="entry-meta">
 <center> <span class="entry-tags">{% for tag in post.tags %}<a href="{{ site.url }}/tags#{{ tag }}" title="Pages tagged {{ tag }}" class="tag"><span class="term">{{ tag }}</span></a>{% unless forloop.last %}{% endunless %}{% endfor %}</span></center>
</div>
